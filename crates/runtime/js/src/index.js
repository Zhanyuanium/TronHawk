...
function start(app, sinks = {}) {
  ...
  app.on("web-contents-created", (_e, contents) => {
    ...
    contents.on("destroyed", () => {
      ...
      const record = windows.get(contentsId);
      const handle = issuedWindowHandle(record, contentsId);
      ...
      // Handle is issued before the record is dropped so a stashed BrowserWindow.id survives.
      fireWindowUnload(handle);
    });
